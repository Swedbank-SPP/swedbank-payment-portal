 ...
 */
class GetExpressCheckoutDetailsResponse extends AbstractResponse
{
    /**
     * API version used.
     *
     ...
     * @Annotation\Type("SwedbankPaymentPortal\PayPal\CommunicationEntity\GetExpressCheckoutDetailsResponse\PayPalTxn")
     */
    private $payPalTxn;
