 ...
 */
class DoExpressCheckoutPaymentResponse extends AbstractResponse
{
    /**
     * API version used.
     *
     ...
     * @Annotation\Type("SwedbankPaymentPortal\PayPal\CommunicationEntity\DoExpressCheckoutPaymentResponse\PayPalTxn")
     */
    private $payPalTxn;
